...
public class SwitchManager {
	...
	public Properties switches = new Properties();
	private SignEdit plugin;
	
	public SwitchManager(SignEdit plugin) {
		this.plugin = plugin;
		load();
	}
	...
	private void load() {
        try {
    		...
    		File savedTextsFile = new File(plugin.getDataFolder().getPath(), "switches.dat");
	...
	private void save() {
    	try {
    		...
    		switches.store(out, "DO NOT EDIT THIS FILE!");
...
//	public boolean addSwitch(Sign sign) {
//		
//	}
	
	public boolean saveExists(String saveId) {
		if (switches.containsKey(saveId)) {
			return true;
		}
		return false;
	}
	...
	public boolean loadText(String saveId, Sign sign) {
		if (saveExists(saveId)) {
			String[] text = switches.getProperty(saveId).split("°");
	...
	public boolean saveText(String saveId, String line0, String line1, String line2, String line3) {
		if (!saveExists(saveId)) {
			...
			switches.setProperty(saveId, text);
			save();
